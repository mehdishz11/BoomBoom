...
public class DatePickerDialog extends DialogFragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mSelectedMonthTextView.setTypeface(TypefaceHelper.get(getContext(),"IRANSansMobile(FaNum)_Medium"));
        mSelectedDayTextView.setTypeface(TypefaceHelper.get(getContext(),"Roboto-Medium"));
        mYearView.setTypeface(TypefaceHelper.get(getContext(),"IRANSansMobile(FaNum)_Medium"));
...
//        view.setBackgroundColor(activity.getResources().getColor(bgColorResource));
        ...
        okButton.setTypeface(TypefaceHelper.get(activity,"IRANSansMobile(FaNum)_Medium"));
        ...
        cancelButton.setTypeface(TypefaceHelper.get(activity,"IRANSansMobile(FaNum)_Medium"));
