...
public class TimePickerDialog extends DialogFragment implements OnValueSelectedListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mOkButton.setTypeface(TypefaceHelper.get(getDialog().getContext(),"IRANSansMobile(FaNum)_Medium"));
        ...
        mCancelButton.setTypeface(TypefaceHelper.get(getDialog().getContext(),"IRANSansMobile(FaNum)_Medium"));
