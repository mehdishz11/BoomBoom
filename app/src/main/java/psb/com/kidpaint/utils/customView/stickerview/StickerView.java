package psb.com.kidpaint.utils.customView.stickerview;
...
public abstract class StickerView extends FrameLayout {
    ...
    public StickerView.onVisibilityChange getOnVisibilityChange() {
        return onVisibilityChange;
    }

    public void setOnVisibilityChange(StickerView.onVisibilityChange onVisibilityChange) {
        this.onVisibilityChange = onVisibilityChange;
    }

    public void setOnRemoved(StickerView.onRemoved onRemoved) {
    ...
    private void init(Context context) {
        ...
        Integer id = new Random().nextInt(1000) + 1;
        setId(id);
        ...
        LayoutParams iv_checked_params =
                new LayoutParams(
                        convertDpToPixel(BUTTON_SIZE_DP, getContext()),
                        convertDpToPixel(BUTTON_SIZE_DP, getContext())
                );
        iv_checked_params.gravity = Gravity.TOP | Gravity.LEFT;
        ...
        this.addView(iv_check, iv_checked_params);
        ...
        this.iv_check.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
    ...
    public String getStickerSound() {
        return stickerSound;
    }

    public void setStickerSound(String stickerSound) {
    ...
    public interface onVisibilityChange {
        void onControllerVisibilityChange(int id, boolean isShow);
    }
