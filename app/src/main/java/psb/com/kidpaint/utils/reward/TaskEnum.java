...
public enum TaskEnum {
    STEP_2(4, 5,200,15,"امتیاز دادن","به برنامه ۵ امتیاز دهید و ۲۰ سکه جایزه بگیرید"),
    STEP_1(3, 8,150,14,"اشتراک گذاری","برنامه را با دوستان خود به اشتراک بگذارید و ۱۵ سکه جایزه بگیرید\nدر ضمن با این کار کمک بزرگی به ما کردین");
